...
if (reversed == null) { reversed = false; }
	...
	this.instance_2 = new lib.player2_mc();
	this.instance_2.setTransform(40,43,1,1,0,0,0,40,43);

	this.instance_3 = new lib.player3_mc();
	this.instance_3.setTransform(40,43,1,1,0,0,0,40,43);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_3}]},8).wait(9));
...
(lib.fioor_mc = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
if (reversed == null) { reversed = false; }
	...
	// endText
	this.gameover_text = new cjs.Text("  GAME OVER\npress any key", "40px 'Press Start 2P'", "#666666");
	this.gameover_text.name = "gameover_text";
	this.gameover_text.lineHeight = 57;
	this.gameover_text.lineWidth = 521;
	this.gameover_text.parent = this;
	this.gameover_text.setTransform(379.3,186.2);

	this.timeline.addTween(cjs.Tween.get(this.gameover_text).wait(1));

	// score
	this.score_text = new cjs.Text("00000", "35px 'Press Start 2P'", "#666666");
	this.score_text.name = "score_text";
	this.score_text.lineHeight = 50;
	this.score_text.lineWidth = 209;
	this.score_text.parent = this;
	this.score_text.setTransform(1044.95,74.95);
	...
	// floor
	this.floor_mc = new lib.fioor_mc();
...
p.nominalBounds = new cjs.Rectangle(640,433,1760,41);
// library properties:
lib.properties = {
	id: '4A93743A06D6EC40B743C477D4A6CF1E',
	width: 1280,
	height: 720,
	fps: 60,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/dino_atlas_1.png?1657603036121", id:"dino_atlas_1"}
	],
	preloads: []
};
...
an.compositions['4A93743A06D6EC40B743C477D4A6CF1E'] = {
